...
# ``databricks_ci_cd/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-databricks_ci_cd-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.databricks_ci_cd.databricks_ci_cd-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.databricks_ci_cd.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.databricks_ci_cd.trip_dropoff_features",
