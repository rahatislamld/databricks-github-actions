...
git add README.md docs .gitignore databricks_ci_cd/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[databricks_ci_cd/databricks.yml](../databricks_ci_cd/databricks.yml) file.
...
Follow the instructions in [databricks_ci_cd/resources/README.md](../databricks_ci_cd/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../databricks_ci_cd/resources/README.md)  to propose, test, and deploy
