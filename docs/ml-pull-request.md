...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks_ci_cd-run-tests.yml) 
...
Links:
* [Staging model in UC](https://your-staging-workspace.cloud.databricks.com/explore/data/models/staging/databricks_ci_cd/databricks_ci_cd-model)
* [Prod model in UC](https://your-prod-workspace.cloud.databricks.com/explore/data/models/prod/databricks_ci_cd/databricks_ci_cd-model)
. 
